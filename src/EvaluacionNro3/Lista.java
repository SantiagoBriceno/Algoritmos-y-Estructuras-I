...
public class Lista {
    ...
    public void ordenarLista(){
        ...
        if(longitud()> 1){
            ...
            Nodo siguiente = cabecera.getEnlace();
            while(siguiente != null){
                if((int)anterior.getElem() > (int)siguiente.getElem()){
                    aux = (int)siguiente.getElem();
                    siguiente.setElem(anterior.getElem());
                    anterior.setElem(aux);
                    if(siguiente==cabecera.getEnlace()){
                        anterior = siguiente;
                        siguiente = siguiente.getEnlace();
                    }else{
                        anterior = cabecera;
                        siguiente = cabecera.getEnlace();
                    }
                }else{
                    anterior = siguiente;
                    siguiente = siguiente.getEnlace();
